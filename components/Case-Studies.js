...
import { FiDollarSign, FiTrendingUp, FiMousePointer, FiTarget } from "react-icons/fi"
...
const caseStudies = {
  AccentStudios: {
    ...
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/2-SGuVAMw0HzFJWKAWBftebMqDYWcZyf.png",
  ...
  "Viva Reveal": {
    ...
    image: "/modern-beauty-wellness-spa-with-soft-lighting.png",
  ...
  Pathos: {
    ...
    image: "/modern-tech-startup-office-with-computers-and-inno.png",
    ...
    <section className="case-studies-section">
      ...
      <div className="header">
        ...
        <h2 className="main-title">
          Case Studies & <span className="highlight">Success Stories</span>
        </h2>
        <p className="subtitle">Recent highlights from past/current brands we've helped scale</p>
      </div>
      ...
      <div className="case-study-card">
        <div className="card-grid">
          ...
          <div className="image-container">
            <img src={currentCase.image || "/placeholder.svg"} alt={currentCase.imageAlt} className="case-image" />
          ...
          <div className="content-area">
            ...
            <h3 className="case-title">
              {currentCase.title} <span className="revenue-highlight">[$0 → {currentCase.revenue}]</span>
            </h3>
            ...
            <div className="metrics-grid">
              <div className="metric-card primary">
                <div className="metric-header">
                  ...
                  <span className="metric-value">{currentCase.metrics.revenue}</span>
                </div>
              ...
              <div className="metric-card primary">
                <div className="metric-header">
                  ...
                  <span className="metric-value">{currentCase.metrics.adspend}</span>
                </div>
              ...
              <div className="metric-card secondary">
                <div className="metric-header">
                  ...
                  <span className="metric-value">{currentCase.metrics.orders}</span>
                </div>
              ...
              <div className="metric-card secondary">
                <div className="metric-header">
                  ...
                  <span className="metric-value">{currentCase.metrics.roas}</span>
                </div>
            ...
            <div className="tags-container">
              {Object.keys(caseStudies).map((caseKey) => (
                <button
                  ...
                  className={`tag-button ${activeCase === caseKey ? "active" : "inactive"}`}
                >
                  {caseKey}
                </button>
              ))}
